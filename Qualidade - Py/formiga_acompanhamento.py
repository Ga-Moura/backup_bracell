...
caminho_completo = os.path.abspath(
    r"\\GLWFS02.lwart.net\LWC-FLORESTAL\Qualidade_Florestal\01- SÃO PAULO\02- Silvicultura e Sobrevivência\00 - Arquivos Surveys\QLDformigamanualacompanhamento_attachments")
...
username = cred['login']
password = cred['senha']
survey_item = cred['QLD_formiga_manual_acompanhamento']
