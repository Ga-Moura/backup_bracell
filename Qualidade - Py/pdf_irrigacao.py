...
path = r"F:\Qualidade_Florestal\01- SÃO PAULO\02- Silvicultura e Sobrevivência\00 - Arquivos Surveys\QLDirrigacaosilvicultura_attachments"
...
url_base_att = r'F:\Qualidade_Florestal\01- SÃO PAULO\02- Silvicultura e Sobrevivência\00 - Arquivos Surveys\QLD_irrigacao_silvicultura_attachments.csv'


# In[29]:


url_base_survey = r'F:\Qualidade_Florestal\01- SÃO PAULO\02- Silvicultura e Sobrevivência\00 - Arquivos Surveys\QLD_irrigacao_silvicultura.xlsx'
...
survey = survey[['objectid', 'fazenda', 'id_talhao',
                 'nivel', 'data', 'observacoes_gerais', 'regiao']]
...
caminho_completo = os.path.abspath(
    r"F:/Qualidade_Florestal/01- SÃO PAULO/02- Silvicultura e Sobrevivência/00 - Arquivos Surveys/Arquivos PDF/Irrigação")
...
for i, row in survey.iterrows():
    try:
        ...
        cnv = canvas.Canvas(
            r'F:/Qualidade_Florestal/01- SÃO PAULO/02- Silvicultura e Sobrevivência/00 - Arquivos Surveys/Arquivos PDF/irrigação/' + filename)
        ...
        cnv.drawString(110, (820-20), "Evidência de Irrigação")
