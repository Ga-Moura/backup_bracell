...
caminho_completo = os.path.abspath(
    r"F:\Qualidade_Florestal\01- SÃO PAULO\02- Silvicultura e Sobrevivência\00 - Arquivos Surveys\QLDadubacaoprecisaoepulverizacao_attachments")
...
username = cred['login']
password = cred['senha']
survey_item = cred['QLD_adubacao_precisao_e_pulverizacao']
...
base_survey = base_survey[['objectid', 'data_avaliacao']]

base_survey['mes_ano'] = base_survey['data_avaliacao'].dt.to_period('M')
