...
import os
caminho_completo = os.path.abspath(r"F:\Qualidade_Florestal\01- SÃO PAULO\02- Silvicultura e Sobrevivência\00 - Arquivos Surveys\QLDpulverizacaocomdrone_attachments")
...
username = cred['login']
password = cred['senha']
survey_item_id = cred['QLD_pulverizacao_com_drone']
