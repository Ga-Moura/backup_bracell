...
caminho_completo = os.path.abspath(
    r"\\GLWFS02.lwart.net\LWC-FLORESTAL\Qualidade_Florestal\01- SÃO PAULO\02- Silvicultura e Sobrevivência\00 - Arquivos Surveys\dados_attachments")
...
username = cred['login']
password = cred['senha']
survey_item = cred['desseca_equilibrio']
...
url_base_survey = r'F:\Qualidade_Florestal\01- SÃO PAULO\02- Silvicultura e Sobrevivência\00 - Arquivos Surveys\Desseca_Equilibrio.xlsx'

base_survey = pd.read_excel(url_base_survey)

base_survey = base_survey[['objectid', 'dataevento']]

base_survey['mes_ano'] = base_survey['dataevento'].dt.to_period('M')
