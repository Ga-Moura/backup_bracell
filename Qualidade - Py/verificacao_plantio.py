...
import os
caminho_completo = os.path.abspath(r"\\GLWFS02.lwart.net\LWC-FLORESTAL\Qualidade_Florestal\01- SÃO PAULO\02- Silvicultura e Sobrevivência\00 - Arquivos Surveys\fragmentos_attachments")
...
username = cred['login']
password = cred['senha']
survey_item_id = cred['QLD_verificacao_plantio']
...
url_base_survey = r'F:\Qualidade_Florestal\01- SÃO PAULO\02- Silvicultura e Sobrevivência\00 - Arquivos Surveys\QLDverificacaoplantio.xlsx'
