...
path = r"\\GLWFS02.lwart.net\LWC-FLORESTAL\Qualidade_Florestal\01- SÃO PAULO\02- Silvicultura e Sobrevivência\00 - Arquivos Surveys\QLDadubacaoprecisaoepulverizacao_attachments"
...
url_base_att = r'F:\Qualidade_Florestal\01- SÃO PAULO\02- Silvicultura e Sobrevivência\00 - Arquivos Surveys\QLD_adubacao_precisao_e_pulverizacao_attachments.csv'


# In[364]:


url_base_survey = r'F:\Qualidade_Florestal\01- SÃO PAULO\02- Silvicultura e Sobrevivência\00 - Arquivos Surveys\QLD_adubacao_precisao_e_pulverizacao.xlsx'
...
survey = survey[['objectid', 'fazenda', 'id_talhao', 'nivel',
                 'data_avaliacao', 'observacoes_gerais', 'regiao']]
...
caminho_completo = os.path.abspath(
    r"F:\Qualidade_Florestal\01- SÃO PAULO\02- Silvicultura e Sobrevivência\00 - Arquivos Surveys\Arquivos PDF\Adubação e Herbicida de Precisão")
...
for i, row in survey.iterrows():
    try:
        ...
        cnv = canvas.Canvas(
            r'F:\Qualidade_Florestal\01- SÃO PAULO\02- Silvicultura e Sobrevivência\00 - Arquivos Surveys\Arquivos PDF\Adubação e Herbicida de Precisão/' + filename)
        ...
        cnv.drawString(
            110, (820-20), "Evidência de Adubação e Herbicida de Precisão")
