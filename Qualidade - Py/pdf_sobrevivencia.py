...
path = r"F:\Qualidade_Florestal\01- SÃO PAULO\02- Silvicultura e Sobrevivência\00 - Arquivos Surveys\QLDsobrevivenciasilvicultura_attachments"
...
url_base_att = r'F:\Qualidade_Florestal\01- SÃO PAULO\02- Silvicultura e Sobrevivência\00 - Arquivos Surveys\QLD_sobrevivencia_silvicultura_attachments.csv'


# In[61]:


url_base_survey = r'F:\Qualidade_Florestal\01- SÃO PAULO\02- Silvicultura e Sobrevivência\00 - Arquivos Surveys\QLD_sobrevivencia_silvicultura.xlsx'
...
survey = survey[['objectid','nome_fazenda', 'talhao','nivel','datahoje', 'observacoes_gerais','regiao']]
...
survey['url_nc_evidencia'] = survey['url_nc_evidencia'].apply(lambda x: foto_branco if pd.isnull(x) else x)
...
import os
caminho_completo = os.path.abspath(r"F:\Qualidade_Florestal\01- SÃO PAULO\02- Silvicultura e Sobrevivência\00 - Arquivos Surveys\Arquivos PDF\Sobrevivência")
...
for i, row in survey.iterrows():
        try:
                ...
                cnv = canvas.Canvas(r'F:\Qualidade_Florestal\01- SÃO PAULO\02- Silvicultura e Sobrevivência\00 - Arquivos Surveys\Arquivos PDF\Sobrevivência/' + filename)
                ...
                cnv.drawString(110,(820-20), "Evidência de Sobrevivência")
        ...
        #Adicionar imagem aqui
                cnv.drawImage(str(row['url_nc_evidencia']),40,80,width=200,height=200)
