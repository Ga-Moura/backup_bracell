...
caminho_completo = os.path.abspath(
    r"F:\Qualidade_Florestal\01- SÃO PAULO\02- Silvicultura e Sobrevivência\00 - Arquivos Surveys\QLDirrigacaosilvicultura_attachments")
...
username = cred['login']
password = cred['senha']
survey_item = cred['QLD_irrigacao_silvicultura']
