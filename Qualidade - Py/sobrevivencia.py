...
import os
caminho_completo = os.path.abspath(r"\\GLWFS02.lwart.net\LWC-FLORESTAL\Qualidade_Florestal\01- SÃO PAULO\02- Silvicultura e Sobrevivência\00 - Arquivos Surveys\QLDsobrevivenciasilvicultura_attachments")
...
username = cred['login']
password = cred['senha']
survey_item_id = cred['QLD_sobrevivencia_silvicultura']
...
base_survey = base_survey[['objectid','datahoje']]

base_survey['mes_ano'] = base_survey['datahoje'].dt.to_period('M')
