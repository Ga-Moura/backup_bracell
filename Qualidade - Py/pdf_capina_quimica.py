...
path = r"F:\Qualidade_Florestal\01- SÃO PAULO\02- Silvicultura e Sobrevivência\00 - Arquivos Surveys\QLDcapinaquimicamanual_attachments"
...
url_base_att = r'F:\Qualidade_Florestal\01- SÃO PAULO\02- Silvicultura e Sobrevivência\00 - Arquivos Surveys\QLD_capina_quimica_manual_attachments.csv'


# In[10]:


url_base_survey = r'F:\Qualidade_Florestal\01- SÃO PAULO\02- Silvicultura e Sobrevivência\00 - Arquivos Surveys\QLD_capina_quimica_manual.xlsx'
...
import os
caminho_completo = os.path.abspath(r"F:\Qualidade_Florestal\01- SÃO PAULO\02- Silvicultura e Sobrevivência\00 - Arquivos Surveys\Arquivos PDF\Capina Química Manual")
...
for i, row in survey.iterrows():
        try:
                ...
                cnv = canvas.Canvas(r'F:\Qualidade_Florestal\01- SÃO PAULO\02- Silvicultura e Sobrevivência\00 - Arquivos Surveys\Arquivos PDF\Capina Química Manual/' + filename)
                ...
                cnv.drawString(110,(820-20), "Evidência de Capina Química Manual")
